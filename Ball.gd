...
func cartesian_to_kinematics(df : Vector2):
	...
	if dir < 0:
		dir += 360
	if round(dir) == 0:
		return str(round(df.length()/100))+"m/s [W]"
	elif 90 > dir and dir > 0:
		return str(round(df.length()/100))+"m/s [E "+str(round(dir))+"\u00B0 S]"
	elif round(dir) == 90:
		return str(round(df.length()/100))+"m/s [S]"
	elif 180 > dir and dir > 90:
		return str(round(df.length()/100))+"m/s [S "+str(round(dir-90))+"\u00B0 W]"
	elif round(dir) == 180:
		return str(round(df.length()/100))+"m/s [E]"
	elif 270 > dir and dir > 180:
		return str(round(df.length()/100))+"m/s [W "+str(round(dir-180))+"\u00B0 N]"
	elif round(dir) == 270:
		return str(round(df.length()/100))+"m/s [N]"
	elif 360 > dir and dir > 270:
		return str(round(df.length()/100))+"m/s [N "+str(round(dir-270))+"\u00B0 E]"
